 ...
 * @param {object} props 
 * @param {any} [props.children="Links to new user page"] - The content displayed inside the link example: "homepage", falls back on "Links to new  user page" if not provided.
