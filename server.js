...
app.get("/api/games", async (req, res) => {
  ...
  try {
    ...
    const response = await axios({
      ...
      data: `fields name,cover.url,summary,storyline,rating,first_release_date,genres.name,platforms.name,screenshots.url,age_ratings.*,type,involved_companies.*,involved_companies.company.; 
             limit ${limit}; 
